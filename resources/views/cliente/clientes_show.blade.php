            ...
            <div class="row ">
                ...
                <div class="col-lg-4 text-center" style="padding-bottom: 10px">
                    ...
                    <div class="text-center">
                        <a href="{{route("clientes.edit",["id"=>$user->id])}}" style=" width: 130px; display: inline-block; background: #0d6efd; color: white; border: 2px solid #ffffff;border-radius: 10px; font-size: large"
                           class="btn btn-google btn-user ">
                            {{ __('Editar') }}
                        </a>
                        <a href="/clientes" style="width: 130px; display: inline-block; background: #b02a37; color: white; border: 2px solid #ffffff;border-radius: 10px; font-size: large"
                           class="btn btn-google btn-user ">
                            {{ __('Regresar') }}
                        </a>
                    </div>
