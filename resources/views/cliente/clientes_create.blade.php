    ...
    <div class="card shadow mb-4 ">
        ...
        <div class="card-header py-3" style="background: #0d6efd; border-radius:5px 5px 0 0;">
            ...
            <div style="float: left">
                <h2 class="m-0 font-weight-bold" style="color: white">Añadir cliente</h2>
            </div>
        </div>
        <br>
        <div class="container">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5 mb-3 mb-sm-0" style="margin-top: 6px">
                                    ...
                                    <input  type="type" class="form-control @error('type') is-invalid @enderror" id="type"
                                            name="type" value="Cliente"
                                            required autocomplete="type" readonly style="background-color: white">
                                    @error('type')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-sm-12 mb-3 mb-sm-0"
                                ...
                                <div class="col-lg-7 d-none d-lg-block">
                                    <div class="text-center">
                                        <img id="imagen" style="background-color: #0d6efd" src="" class="img-fluid rounded" width="1200" height="1200">
                                    </div>
