    ...
    <div class="card shadow mb-4 ">
        ...
        <div class="card-header py-3" style="background: #0d6efd; border-radius:5px 5px 0 0;">
            ...
            <div style="float: left">
                <h2 class="m-0 font-weight-bold" style="color: white">Crear reparacion</h2>
            </div>
        </div>
        <br>
        <div class="container">
            <form action="{{ route('reparaciones.create')}}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="form-group row">
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    ...
                                    <input type="date" class="form-control @error('fecha_entrada') is-invalid @enderror"
                                           id="fecha_entrada"
                                           name="fecha_entrada" value="{{Carbon\Carbon::now()->format('Y-m-d')}}"
                                           required
                                ...
                                <div class="col-sm-6 mb-3 mb-sm-0" style="margin-top: 6px">
                                    ...
                                    <select class="form-control @error('cliente_id') is-invalid @enderror"
                                        ...
                                        @foreach ($usuarios as $usuario)
                                            <option value="{{ $usuario->id }}" {{ old('cliente_id') == $usuario->id ? 'selected' : '' }}>{{$usuario['name']}}</option>
                                        @endforeach
                                    </select>
                                    @error('cliente_id')
                                    <span class="invalid-feedback" role="alert">
