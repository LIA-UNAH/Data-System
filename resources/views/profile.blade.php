            ...
            <div class="row" style="background: #4a5568">
                ...
                <div class="col-lg-5 d-none d-lg-block" style="text-align: center; padding-top: 50px">
                    ...
                    <div class="col-sm-12 col-xs-12" style="text-align: center; margin-top: 15px; margin-bottom: 15px">
                        ...
                        <a href="javascript:history.back()" style="margin-left: 4px; width: 145px; display: inline-block; background: #b02a37; color: white; border: 2px solid #ffffff;border-radius: 4px; font-size: large"
                           class="btn btn-google btn-user ">
                            {{ __('Regresar') }}
                        </a>
                    </div>
