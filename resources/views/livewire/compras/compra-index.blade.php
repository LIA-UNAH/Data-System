                ...
                <table class="table table" id="dataTable">
                    ...
                    @forelse($compras as $compra)
                        <tr style="font-family: 'Nunito', sans-serif; font-size: small">
                            ...
                            @if($compra->estado_compra != 'p')
                                <td style="text-align: center">
                                    <a class="btn btn-primary" href="{{ route('compras.facturas', ['compra' => $compra->id]) }}">
                                        <i class="fa fa-eye" style="color: white"></i>
                                    </a>
                                </td>
                                <td style="text-align: center">
                                    <a class="btn btn-success" href="#" data-bs-toggle="modal" data-bs-target="#modal_editar_cliente">
