                ...
                <table class="table" id="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr style="font-family: 'Nunito', sans-serif; font-size: small">
                            ...
                            <td>
                                <span class="badge rounded-pill text-bg-light p-2 shadow-sm">{{$venta->estado ===
                                    "en_proceso" ? "En Proceso" : "Pagada"}}</span>
                            </td>

                            <td>
                                <div class="d-flex col-8">
                                    <a class="btn btn-info mr-2"
                                        href="{{ route('ventas.facturas', ['venta' => $venta->id]) }}">Ver</a>
