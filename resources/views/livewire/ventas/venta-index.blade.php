<div>
    ...
    <div>
        ...
        <p class="badge bg-secondary">Busqueda:
            {{ empty($this->filtros['busqueda']) ? 'cualquiera' : $this->filtros['busqueda'] }}</p>
    </div>
                    ...
                    <tbody>
                        @forelse($ventas as $venta)
                            <tr style="font-family: 'Nunito', sans-serif; font-size: small">
                                ...
                                <td>
                                    <span
                                        class="badge rounded-pill text-bg-light p-2 shadow-sm">{{ $venta->estado === 'en_proceso' ? 'En Proceso' : 'Pagada' }}</span>
                                </td>
                                    ...
                                    <div class="d-flex col-8">
                                        ...
                                        @if ($venta->estado == 'en_proceso')
                                            <a class="btn btn-success mr-2"
                                                href="{{ route('ventas.edit', ['id' => $venta->id]) }}">Editar</a>
                                            <a class="btn btn-danger mr-2" href="#" data-bs-toggle="modal"
                                                data-bs-target="#modalEliminarVenta{{ $venta->id }}">
                                ...
                                <div class="modal fade" id="modalEliminarVenta{{ $venta->id }}"
                                    data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                    aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="staticBackdropLabel">Eliminar Venta
                                                </h5>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button class="btn btn-danger btn-sm"
                                                    wire:click="eliminarVenta({{ $venta->id }})">Eliminar</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
