        ...
        <div class="page-header text-blue-d2">
            ...
            <div class="page-tools" style="">
                <div class="action-buttons" >
                    ...
                    <a class="print btn bg-white btn-light mx-1px text-95" >
...
function imprimirElemento(elemento) {
  ...
  ventana.document.write('<body></body>');
  ventana.document.write('<link href={{ asset("admin/fontawesome/css/all.min.css") }} rel="stylesheet" type="text/css">');
  ventana.document.write('<link href={{ asset("css/fonts.css") }} rel="stylesheet" type="text/css">');
  ventana.document.write('<link href={{ asset("css/card.css") }} rel="stylesheet" type="text/css">');
  ventana.document.write('<link href={{ asset("admin/css/sb-admin-2.min.css") }} rel="stylesheet" type="text/css">');
  ventana.document.write('<link href={{ asset("css/bootstrap.min.css") }} rel="stylesheet" type="text/css">');
  ventana.document.write('<link href={{ asset("css/pdf.css") }} rel="stylesheet" type="text/css" >');
