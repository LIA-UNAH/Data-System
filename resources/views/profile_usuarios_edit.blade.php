    ...
    <div class="card shadow mb-4 ">
        ...
        <div class="card-header py-3" style="background: #0d6efd; border-radius:5px 5px 0 0;">
            ...
            <div style="float: left">
                <h2 class="m-0 font-weight-bold" style="color: white">Editar perfil</h2>
            </div>
        </div>
        <br>
        <div class="container">
            <form method="POST" action="{{route("usuarios.edit_profile",["id"=>$user->id])}}" enctype="multipart/form-data">
                @method("PUT")
                @csrf
