...
@section('content')
    ...
    <div class="card shadow mb-4 " style="height: calc(90vh - 5vh);">
        ...
        @else
            ...
            <div class="card-body" style="overflow-y: auto;" id="cartas_table" >
                <div>
                            ...
                            <div class="col">
                                <div class="wsk-cp-product">
                                    ...
                                    <div class="wsk-cp-text">
                                        ...
                                        <div class="category">
                                            <span><strong>{{ $producto->marca }} {{ $producto->modelo }}</strong></span>
                                        </div>
                                        <div style="padding-bottom: 10px">
                                            <span class="price text-center">{{ $producto->existencia }} unidades</span>
                                        </div>
