                            ...
                            <div class="form-group row">
                                <div class="col-sm-4 mb-3 mb-sm-0">
                                    ...
                                    <input type="text" class="form-control @error('prec_compra') is-invalid @enderror"
                                           id="prec_compra"
                                           name="prec_compra" value="{{ old('prec_compra') }}" required
                                ...
                                <div class="col-sm-4 mb-3 mb-sm-0">
                                    ...
                                    <input type="text"
                                           ...
                                           id="prec_venta_may"
                                           name="prec_venta_may" value="{{ old('prec_venta_may') }}" required
                                ...
                                <div class="col-sm-4 mb-3 mb-sm-0">
                                    ...
                                    <input type="text"
                                           ...
                                           id="prec_venta_fin"
                                           name="prec_venta_fin" value="{{ old('prec_venta_fin') }}" required
