            ...
            <form action="{{ route('productos.create')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body" style="font-family: 'Nunito', sans-serif; font-size: small; padding: 10px">
                    <div class="row g-3">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <div class="col-sm-4 mb-3 mb-sm-0">
                                    ...
                                    <input type="text" class="form-control @error('prec_compra') is-invalid @enderror" id="prec_compra"
                                           name="prec_compra" value="{{ old('prec_compra') }}" required autocomplete="prec_compra"
                                ...
                                <div class="col-sm-4 mb-3 mb-sm-0">
                                    ...
                                    <input type="text" class="form-control @error('prec_venta_may') is-invalid @enderror" id="prec_venta_may"
                                           name="prec_venta_may" value="{{ old('prec_venta_may') }}" required autocomplete="prec_venta_may"
                                           autofocus maxlength="10"
                                           onkeypress="return funcionLempiras(event);">
                                ...
                                <div class="col-sm-4 mb-3 mb-sm-0">
                                    ...
                                    <input type="text" class="form-control @error('prec_venta_fin') is-invalid @enderror" id="prec_venta_fin"
                                           name="prec_venta_fin" value="{{ old('prec_venta_fin') }}" required autocomplete="prec_venta_fin"
                                           autofocus maxlength="10"
                                           onkeypress="return funcionLempiras(event);">
                                ...
                                <div class="col-sm-4 mb-3 mb-sm-0" style="margin-top: 6px">
                                    ...
                                    <input type="text" class="form-control @error('existencia') is-invalid @enderror" id="existencia"
                                           name="existencia" value="{{ old('existencia') }}" required autocomplete="existencia"
                                ...
                                <div class="col-sm-4 mb-3 mb-sm-0" style="margin-top: 6px">
                                    ...
                                    <select class="form-control @error('id_categoria') is-invalid @enderror"  id="id_categoria"
                                ...
                                <div class="col-sm-12 mb-3 mb-sm-0" style="margin-top: 6px">
                                    ...
                                    <input type="file" accept="image/*" class="form-control @error('imagen_producto') is-invalid @enderror" id="imagen_producto"
                                           name="imagen_producto" value="{{ old('imagen_producto') }}" required autocomplete="imagen_producto"
                        ...
                        <div class="col-sm-6">
                            <div class="col-sm-12 mb-3 mb-sm-0" style="display: flex; align-items: center; justify-content: center;padding: 10px">
                                <div class="col-lg-7 d-none d-lg-block">
                                    <div class="text-center">
                                        <img id="imagen" src="" class="img-fluid rounded" width="600" height="600">
                                    </div>

                                    <div class="form-group row" style="margin-top: 15px">
                                        <div class="col-sm-6">
                                            <a href="/productos" style="display: inline-block; background: #b02a37; color: white; border: 2px solid #ffffff;border-radius: 10px; font-size: large"
